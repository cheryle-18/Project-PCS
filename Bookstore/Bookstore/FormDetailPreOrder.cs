    ...
    public partial class FormDetailPreOrder : Form
    {
        ...
        public void loadDetails()
        {
            ...
            while (reader.Read())
            {
                ...
                lbDP.Text = reader.GetString(2);
                lbQty.Text = reader.GetString(3);
                lbStatus.Text = reader.GetString(4);
                lbTanggal.Text = reader.GetString(5);

                memberId = reader.GetString(6);
                if (memberId == "Guest")
                {
                    custType = "Guest";
                }
                ...
                lbNamaPeg.Text = reader.GetString(7);
            }
            reader.Close();
