...
namespace Bookstore
{
    public partial class MasterBuku : KryptonForm
    {
        ...
        private string command_querry = "SELECT b.B_ID AS 'Kode Buku',b.B_TITLE AS 'Judul Buku',b.B_AUTHOR AS 'Penulis',p.P_NAME AS 'Penerbit',c.C_NAME AS 'Kategori',CONCAT('Rp ',FORMAT(b.B_PRICE,0, 'de_DE')) AS 'Harga', b.B_STOCK AS 'Stok',b.B_STATUS AS 'Status' " +
